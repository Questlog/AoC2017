...
class Day02Test {
    ...
    private val actualCode = "5048\t177\t5280\t5058\t4504\t3805\t5735\t220\t4362\t1809\t1521\t230\t772\t1088\t178\t1794\n" +
    ...
    @Test
    fun solve() {
        val testCode = "5 1 9 5\n" +
            "7 5 3\n" +
            "2 4 6 8"
        Assert.assertEquals( 18, de.questlog.day02.solve(testCode))

        println("Code: " + de.questlog.day02.solve(actualCode))
    }

    @Test
    fun solvePartTwo() {
        val testCode = "5 9 2 8\n" +
            "9 4 7 3\n" +
            "3 8 6 5"

        Assert.assertEquals( 9, de.questlog.day02.solvePartTwo(testCode))

        println("Code part two: " + de.questlog.day02.solvePartTwo(actualCode))
    }
}